<?php get_header(); ?>
    ...
    <div class="container-fluid background-post text-center">
        <div class="row">
        <h2 class="titulo-post"> ¡Conoce las recomendaciones  <br> más <span class="titulo-reciente">recientes</span>! </h2>
        <?php
            $args = array(
                'posts_per_page' => 6
            );
        ...
        <div class="col-xs-6 col-md-4 entrada">
            ...
            <div class="contenido-entrada">
                <?php the_title('<h3>', '</h3>');?>
                <a href="<?php the_permalink(); ?>" class="btn-post"> Leer más</a>
            </div>
        </div>
     ...
     <div class= "sec-categorias container text-center">
        <h2 class="titulo-cat"> Visita estas increibles categorías </h2>
    ...
    <?php
        get_template_part('includes/es/contactanos');
    ?>
